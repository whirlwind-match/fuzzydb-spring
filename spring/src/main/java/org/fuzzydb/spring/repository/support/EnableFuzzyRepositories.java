...
@Documented
@Inherited
@Import(FuzzyRepositoriesRegistrar.class)
public @interface EnableFuzzyRepositories {

	/**
	 * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation declarations e.g.:
	 * {@code @EnableFuzzyRepositories("org.my.pkg")} instead of {@code @EnableFuzzyRepositories(basePackages="org.my.pkg")}.
	 */
